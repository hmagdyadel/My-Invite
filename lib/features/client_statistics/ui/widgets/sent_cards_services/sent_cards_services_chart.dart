...
class SentCardsServicesChart extends StatelessWidget {
  ...
  List<BarChartModel> _generateChartData() {
    return [
      ...
      _createBarChartModel(details.deliveredGuestsNumber, "total_guests_received_cards".tr(), secondaryColor),
      _createBarChartModel(details.failedGuestsNumber, "total_guests_cards_failed".tr(), errorColor),
      _createBarChartModel(details.notSentGuestsNumber, "total_guests_cards_not_sent".tr(), Colors.yellowAccent),
      _createBarChartModel(details.attendedGuestsNumber, "total_guests_attended".tr(), Colors.purple),
    ];
  }
