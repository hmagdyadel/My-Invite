...
class ScanHistoryStates<T> with _$ScanHistoryStates<T> {
  ...
  const factory ScanHistoryStates.successDeleteEvent(T data)=SuccessDeleteEvent<T>;
  const factory ScanHistoryStates.errorCheck({required String message})=ErrorCheck;
  const factory ScanHistoryStates.errorDeleteEvent({required String message})=ErrorDeleteEvent;
}
