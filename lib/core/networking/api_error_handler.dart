...
class ResponseCode {
  ...
  static const int defaultResponse = -7;
}
...
class ResponseMessage {
  ...
  static const String unauthorised = ApiErrors.unauthorizedError; // failure, user is not authorised
  static const String forbidden = ApiErrors.forbiddenError; //  failure, API rejected request
  static const String internalServerError = ApiErrors.internalServerError; // failure, crash in server side
  static const String notFound = ApiErrors.notFoundError; // failure, crash in server side
  ...
  ApiErrorModel getFailure() {
    switch (this) {
      ...
      case DataSource.unauthorised:
        return ApiErrorModel(code: ResponseCode.unauthorised, message: ResponseMessage.unauthorised);
      ...
      case DataSource.defaultError:
        return ApiErrorModel(code: ResponseCode.defaultResponse, message: ResponseMessage.defaultError);
    }
  }
}
